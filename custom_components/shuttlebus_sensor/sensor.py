...
async def async_setup_platform(hass, config, async_add_entities, discovery_info=None):
    ...
    async_track_time_change(
        hass,
        lambda now: asyncio.run_coroutine_threadsafe(fetch_and_update_bus_schedule(), hass.loop),
    ...
    async_track_time_change(
        hass,
        lambda now: asyncio.run_coroutine_threadsafe(check_and_refresh_holiday_data(), hass.loop),
